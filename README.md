...
2. **OpenRouter API Key** - Get from [openrouter.ai](https://openrouter.ai/keys)
...
| **OpenRouter API** | ~$0.001-0.01 per request |
| **TOTAL** | **~$1/month** |
...
2. Verify BOT_TOKEN and OPENROUTER_API_KEY environment variables
...
**Deployed with ❤️ using GitHub + Render + OpenRouter**